using System;
using System.IO;
using DecryptVideos.Entities;
using DecryptVideos.Option;
using DecryptVideos.Encryption;
using System.Linq;
    ...
    public class Decryptor
    {
        ...
        public void DecryptCourse()
        {
            ...
            courses.ForEach(course =>
            {
                ...
                var courseFolder = FileLocator.GetCourseFolder(options.CoursesPath, course.Name);
        ...
        private void CreateModule(Module module, Course course)
        {
            ...
            var moduleFolder = FileLocator.GetModuleFolder(options.CoursesPath, module);
        ...
        private void CreateVideoClip(Clip clip, Module module, DirectoryInfo moduleFolder, string courseTitle)
        {
            ...
            {
                using var fs = FileLocator.CreateVideo(options.OutputPath, courseTitle, module, clip);
        ...
        public void WriteTranscriptFile(Clip clip, Module module, string courseTitle)
        {
            ...
            {
                int i = 1;
                using var fs = FileLocator.CreateVideoTranscript(options.OutputPath, courseTitle, module, clip);
